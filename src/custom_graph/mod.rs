// Based on https://github.com/petgraph/petgraph/blob/master/src/graph_impl/mod.rs
...
use petgraph::{Directed, Direction, EdgeType, Incoming, IntoWeightedEdge, Outgoing, Undirected};

mod iter_format;
use self::iter_format::{DebugMap, IterFormatExt, NoPretty};

mod util;
use self::util::enumerate;
use petgraph::visit;

#[macro_use]
mod macros;
// use self::macros::clone_fields;
